...
${BOLD}Environment names:${RESET} base | workspace | dev | all
...
${BOLD}Examples:${RESET}
  ...
  ./nukelabctl build env base workspace dev
...
with env NAME. Domain-specific images (radiation-transport, gpu, moose, etc.)
are built from the nukelab-environments repository.
EOF
}
