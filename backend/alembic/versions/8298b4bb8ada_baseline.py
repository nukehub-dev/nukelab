...
def upgrade() -> None:
    # If tables already exist (e.g., the app was started with
    # AUTO_CREATE_TABLES=true before migrations were introduced), stamp this
    # baseline revision and skip table creation.
    conn = op.get_bind()
    inspector = inspect(conn)
    if 'server_plans' in inspector.get_table_names():
        op.execute(
            "INSERT INTO alembic_version (version_num) VALUES ('8298b4bb8ada') "
