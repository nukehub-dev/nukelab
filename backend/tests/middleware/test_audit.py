...
class TestAuditMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_log_activity_with_valid_token(self, middleware, mock_request, mock_response, test_user):
    ...
    @pytest.mark.asyncio
    async def test_log_activity_captures_ip_and_user_agent(self, middleware, mock_request, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_log_includes_actor_info_in_details(self, middleware, mock_request, mock_response, test_user):
