...
class EnvironmentService:
    ...
    async def update_environment(self, env_id: str, **updates) -> EnvironmentTemplate:
    ...
    async def clone_environment(
        self, env_id: str, new_name: str, new_slug: str
    ) -> EnvironmentTemplate:
        ...
        if not source:
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND, detail="Source environment not found"
            )
