...
class ServerPlan(Base):
    ...
    user_access = relationship(
        "UserPlanAccess", back_populates="plan", cascade="all, delete-orphan"
    )
    workspace_access = relationship(
        "WorkspacePlanAccess", back_populates="plan", cascade="all, delete-orphan"
    )
