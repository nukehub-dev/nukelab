...
require_server_create = require_permissions(Permission.SERVERS_START)
require_server_manage = require_permissions(Permission.SERVERS_MANAGE)
require_credit_read = require_permissions(Permission.CREDITS_READ)
