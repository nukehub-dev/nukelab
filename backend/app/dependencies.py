...
async def _permission_checker(
    *permissions: str, current_user: User = Depends(get_current_active_user)
):
...
require_workspace_read = require_permissions(
    Permission.WORKSPACES_READ_OWN, Permission.WORKSPACES_READ_ALL
)
