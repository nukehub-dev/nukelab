...
export function CalendarHeatmap({ data, from, to, metric = 'signups', className }: CalendarHeatmapProps) {
          ...
          {[
            ...
            <div key={s.label} className="flex items-center gap-4">
              ...
              <div className="text-center">
                <div className="text-sm font-bold text-foreground tabular-nums">{s.value.toLocaleString()}</div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <div
                  className={cn(
                    ...
                    tooltip.level === 0 ? 'bg-muted ring-muted-foreground/20' : LEVELS[tooltip.level].bg
                  )}
                />
