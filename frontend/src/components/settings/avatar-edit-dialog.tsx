...
export function AvatarEditDialog({
  ...
  const activeSource = useGravatar ? 'gravatar' : currentAvatarUrl ? 'custom' : 'default'
        ...
        {mode === 'crop' && imageSrc && (
          <>
            ...
            <div className="flex items-center gap-3 w-full">
              ...
              <Slider min={0.5} max={4} step={0.05} value={zoom} onChange={setZoom} />
            ...
            <div className="flex items-center gap-2 w-full">
              ...
              <Button type="button" className="flex-1" loading={uploading} onClick={handleUpload}>
