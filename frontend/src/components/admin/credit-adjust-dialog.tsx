...
import { Plus, Minus, Wallet, AlertTriangle, CreditCard } from 'lucide-react'
import {
  Dialog,
  DialogContent,
  DialogHeader,
          ...
          >
            ...
            <div className="flex items-center justify-between text-sm">
              <span className="text-muted-foreground">
                {operation === 'grant' ? 'Granting' : 'Deducting'}
              </span>
              <span
                className={cn(
                  'font-mono font-medium',
                  operation === 'grant' ? 'text-emerald-400' : 'text-red-400'
                )}
              >
                {operation === 'grant' ? '+' : '-'}
                {numericAmount.toLocaleString()} NUKE
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <span className="font-mono font-bold text-lg">
                  {newBalance.toLocaleString()} NUKE
                </span>
                {isOverdraft && (
            ...
            {isOverdraft && (
              ...
              >
                ...
                <span>
                  This deduction would result in a negative balance. Reduce the amount or grant
                  credits first.
                </span>
              </motion.div>
            )}
