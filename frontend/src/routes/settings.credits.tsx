    ...
    <div className="min-h-screen space-y-6">
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">View your credit balance and transaction history</p>
        </div>
      </motion.div>
      ...
      <div className="px-6 lg:px-10 pb-10 space-y-6">
        ...
        >
          <div className="p-5 rounded-xl bg-card/50 border border-border/50 space-y-1">
            ...
            <p className="text-2xl font-bold font-mono">{balance.toLocaleString()} <span className="text-sm text-muted-foreground">NUKE</span></p>
          </div>
          <div className="p-5 rounded-xl bg-card/50 border border-border/50 space-y-1">
            <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <p className="text-2xl font-bold font-mono">{daily.toLocaleString()} <span className="text-sm text-muted-foreground">NUKE</span></p>
          </div>
          <div className="p-5 rounded-xl bg-card/50 border border-border/50 space-y-1">
            <div className="flex items-center gap-2 text-muted-foreground">
        ...
        {summary && (
          ...
          >
            <div className="p-4 rounded-xl bg-primary/[0.03] border border-primary/10 text-center">
              ...
              <p className="text-lg font-semibold font-mono text-emerald-400">+{summary.total_earned.toLocaleString()}</p>
            </div>
            <div className="p-4 rounded-xl bg-primary/[0.03] border border-primary/10 text-center">
              <p className="text-xs text-muted-foreground mb-1">Total Consumed</p>
              <p className="text-lg font-semibold font-mono text-red-400">-{summary.total_consumed.toLocaleString()}</p>
            </div>
            <div className="p-4 rounded-xl bg-primary/[0.03] border border-primary/10 text-center">
              <p className="text-xs text-muted-foreground mb-1">Today Consumed</p>
              <p className="text-lg font-semibold font-mono text-blue-400">{summary.today_consumed.toLocaleString()}</p>
            </div>
            <div className="p-4 rounded-xl bg-primary/[0.03] border border-primary/10 text-center">
              <p className="text-xs text-muted-foreground mb-1">Net Change</p>
              <p className={cn('text-lg font-semibold font-mono', (summary.total_earned - summary.total_consumed) >= 0 ? 'text-emerald-400' : 'text-red-400')}>
                {(summary.total_earned - summary.total_consumed) >= 0 ? '+' : ''}{(summary.total_earned - summary.total_consumed).toLocaleString()}
              </p>
            </div>
          </motion.div>
        )}
